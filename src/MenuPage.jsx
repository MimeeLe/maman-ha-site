...
export default function MenuPage() {
  return (
    <>
      <Helmet>
        <title>Menu | Maman Hà</title>
        <meta
          name="description"
          content="Découvrez le menu de Maman Hà à Strasbourg : cuisine vietnamienne familiale, plats signature et carte à consulter en ligne."
        />
        <link rel="canonical" href="https://maman-ha.com/menu" />
        <meta property="og:title" content="Menu | Maman Hà" />
        <meta
          property="og:description"
          content="Consultez le menu de Maman Hà et découvrez notre cuisine vietnamienne à Strasbourg."
        />
        <meta property="og:url" content="https://maman-ha.com/menu" />
      </Helmet>
