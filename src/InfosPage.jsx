...
export default function InfosPage() {
  return (
    <>
      <Helmet>
        <title>Infos pratiques | Maman Hà</title>
        <meta
          name="description"
          content="Adresse, horaires, contact et informations pratiques pour venir chez Maman Hà, restaurant vietnamien à Strasbourg."
        />
        <link rel="canonical" href="https://maman-ha.com/infos" />
        <meta property="og:title" content="Infos pratiques | Maman Hà" />
        <meta
          property="og:description"
          content="Retrouvez l’adresse, les horaires et le contact de Maman Hà à Strasbourg."
        />
        <meta property="og:url" content="https://maman-ha.com/infos" />
      </Helmet>
